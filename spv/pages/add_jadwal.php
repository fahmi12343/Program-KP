            ...
            <center>
                <form method="post" action="proses/jadwal_proses.php" class="form-horizontal" >
                    <div class="control-group"  >
                                    ...
                                    <div class="controls">
                                    <input type="text" maxlength="5" readonly required="" name="kd_jadwal" value="<?php echo $newID?>" class="span8">
                                </div>
                    </div>
                    ...
                    <div class="control-group">
                                    ...
                                    <div class="controls">
                                    <input type="text" maxlength="2"  required="" name="kelompok" class="span8">
                                </div>
                    </div>
                    ...
                    <div class="control-group">
                                    ...
                                    <div class="controls">
                                    <input type="text" maxlength="11" required="" name="jam" class="span8">
                                </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label for="title" class="col-sm-3 control-label"> Status </label>
                            <div class="controls">
                                ...
                                <select required class="custom-select" name="status" class="span8"> 
                                    <option value="">-Silahkan Pilih-</option>
