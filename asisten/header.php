        ...
        <ul class="nav pull-right">
          <ul class="nav">
            <li class="" ><a title="" href="#"><i class="icon icon-user"></i> <span class="text">Login Sebagai <b>
              <?php echo $user;?></b> - <i>[Asisten]</i></span></a></li>
  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li><a href="index.php?page=jadwal"><i class="icon-list-alt"></i><span>Jadwal Reguler</span> </a> </li>
        <li><a href="index.php?page=jadwalK"><i class="icon-list-alt"></i><span>Jadwal Karyawan</span> </a></li>
      </ul>
    </div>
    <!-- /container --> 
  </div>
